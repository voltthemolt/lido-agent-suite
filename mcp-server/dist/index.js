...
- Address: ${idAgent}
- ERC-8004 ID: ${erc8004Id > 0n ? erc8004Id.toString() : 'Not registered'}
...
- Chain: Base (8453)`,
            ...
            case 'agent_get_receipts': {
                if (!args)
                    throw new McpError(ErrorCode.InvalidRequest, 'Missing arguments');
                const receiptAgent = args.agent;
                const treasuryAddr = LIDO_CONTRACTS.agentTreasury;
